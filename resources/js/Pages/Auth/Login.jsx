                ...
                <form onSubmit={submit}>
                    ...
                    <div className="mb-5">
                        ...
                        <input
                            ...
                            required
                            className="w-full rounded-xl border border-primary/20 bg-gray-100 px-4 py-2.5 text-sm text-primary placeholder-slate-500 outline-none ring-indigo-500/50 transition-all focus:border-indigo-500/50 focus:bg-primary/[0.07] focus:ring-2 backdrop-blur-sm"
