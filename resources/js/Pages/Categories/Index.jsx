        ...
        <AdminLayout title="Categories">
            ...
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Link
                    ...
                    className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition-all hover:shadow-xl hover:shadow-indigo-500/30 hover:brightness-110 active:scale-[0.98] sm:w-auto"
                >
                    ...
                    <table className="w-full text-left text-sm text-slate-300">
                        ...
                        <tbody className="divide-y divide-white/5">
                            {categories.data?.map((category) => (
                                <tr key={category.id} className="transition-colors hover:bg-white/[0.04]">
            ...
            {(!categories.data || categories.data.length === 0) && (
                <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/20 py-16 mt-4">
