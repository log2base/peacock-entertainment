        ...
        >
            ...
            <div className="relative aspect-[2/3] rounded-2xl overflow-hidden mb-5 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] group-hover:-translate-y-2 border border-gray-200 group-hover:border-primary/30">
                {post.image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gray-100 text-primary/40">
        ...
        <div className="mt-16 flex items-center justify-center gap-2 flex-wrap">
            {links.map((link, index) => {
                if (!link.url && link.label === '...') {
                    return <span key={index} className="px-3 py-2 text-primary/50 text-sm">…</span>;
                }
                return (
                    <Link
                        key={index}
                        ...
                        className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 ${link.active
                                ...
                                : link.url
                                    ? 'bg-gray-100 text-primary/80 hover:bg-gray-200 hover:text-primary border border-gray-200'
        ...
        <AppLayout>
            <div className="py-24">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    {hasPosts ? (
                        <>
                            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 md:gap-10">
                                {posts.data.map((post) => (
                        ...
                        <div className="flex flex-col items-center justify-center py-20">
                            ...
                            <p className="text-primary/60 text-lg font-medium">No titles available yet</p>
