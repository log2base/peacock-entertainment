        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950">
            ...
            <aside className="fixed top-0 left-0 z-40 h-screen w-64 border-r border-primary/10 bg-slate-950/80 backdrop-blur-xl">
                ...
                <div className="flex h-16 items-center gap-3 border-b border-primary/10 px-6">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 text-sm font-bold text-primary shadow-lg shadow-indigo-500/25">
                        P
                    </div>
                    <span className="text-lg font-semibold text-primary tracking-tight">Peacock</span>
                </div>
                ...
                <div className="absolute bottom-0 w-full border-t border-primary/10 p-4">
                    <Link
                        href="/"
                        className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-500 transition-all hover:bg-primary/5 hover:text-primary"
                    >
                        <span>←</span>
                        Back to Home
                    </Link>
                    ...
                    {auth?.user && (
                        <div className="flex items-center gap-3">
                            <div className="text-right">
                                <div className="text-sm font-medium text-primary">{auth.user.name}</div>
                            ...
                            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 text-sm font-bold text-primary">
